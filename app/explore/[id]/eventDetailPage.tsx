                    ...
                    <div className="flex flex-col gap-4 lg:flex-row justify-center items-start">
                        <div className="flex flex-col w-full max-w-[650px] mx-auto lg:mx-0 gap-4">
                            <div className="w-full h-[400px] relative rounded-lg overflow-hidden">
                                <Image
                                    src={web3eventDetail.image}
                                    fill={true}
                                    alt={web3eventDetail.title}
                                />
                            </div>
                            <div className="bg-zinc-800 p-4 text-zinc-200 rounded-lg">
                                <div className="flex">
                                    {
                                        web3eventDetail.topics_name.length !== 0
                                        ?<div className="max-w-[80%] w-auto flex px-2 py-1 rounded-2xl bg-neutral-700 items-center">
                                            ...
                                            {web3eventDetail.topics_name.map(topic => 
                                ...
                                <div className="py-2 flex">
                                    ...
                                    <div className=" flex flex-col">
                                        <p className=" text-lg font-bold">{web3eventDetail.start_time}</p>
                                        <p>{web3eventDetail.timezone}</p>
                                    </div>
                                </div>
                                <div className="py-2 flex">
                                    <div className=" w-12 h-12 rounded-xl border border-solid border-slate-500 mr-3 flex justify-center items-center">
                                    ...
                                    <div>
                                        <p className=" text-lg font-bold">{web3eventDetail.addr}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="mt-4 flex gap-4 w-full">
                                <div className="w-[50%] p-4 rounded-lg bg-zinc-800">
                                    ...
                                    <div className="my-2 pl-2 flex items-center">
                                        ...
                                        <p className="pl-2 text-xl font-semibold">{web3eventDetail.organizer}</p>
                                    </div>
                                </div>
                                <div className="w-[50%] p-4 rounded-lg bg-zinc-800">
                                    <div className="my-2 pl-2 border-l-8 border-green-400 flex items-center">
                                    ...
                                    <div className="my-2 pl-2 flex items-center">
                                        <div className=" w-10 h-10 mr-6 relative overflow-hidden rounded-full">
                                            <Image
                                                src={web3eventDetail.manager.avatar}
                                                fill
                                                alt=""
                                            />
                                        </div>
                                        <p className="text-xl font-semibold">{web3eventDetail.manager.nickname}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
